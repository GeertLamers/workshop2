...
public class Validator { // Validates possible user inputs.
	...
	public boolean validateUser(String customerProperty) { //validates a new user
	...
	public boolean validateFirstName() { // logic for validating first names
	...
	public boolean validateLastName() { // logic for validating last names
		if (userInput.matches("[a-zA-Z]")) {
	...
	public boolean validateLastNamePreposition() { // logic for validating last name prepositions
		if (userInput.matches("[a-zA-Z]")) {
			System.out.println("Your last name cannot contain any numbers or special characters");
			return false;
		}
	...
	public boolean validateEmail() { // logic for validating e-mail addresses
	...
	public boolean validatePhoneNumber() { // logic for validating phone numbers
